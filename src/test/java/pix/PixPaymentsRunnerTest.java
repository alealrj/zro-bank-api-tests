...
public class PixPaymentsRunnerTest {
    ...
    public void decodePixQrCodeDynamicDueDate() {
        ...
        Response response = pixPaymentsPayload.getPixQrCodeDecode(qrCodeWithDueDate);
        response.then().statusCode(200);
    ...
    public void paymentPixKeys() {
        ...
        Response response = pixPaymentsPayload.postPixPaymentsKeys(pin, decodePixKeyId, value, description, paymentDate);
